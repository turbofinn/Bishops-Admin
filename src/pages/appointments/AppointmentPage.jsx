  ...
  const confirmAction = async () => {
    ...
    try {
      ...
      const requestBody = {
        ...
        paymentId: booking.paymentId || 'N/A',
        action: "UpdateBooking",
        status: action === 'approve' ? "Accepted" : "Cancelled",
                ...
                <Paper variant="outlined" sx={{ p: 3, borderRadius: 2 }}>
                  <Grid container spacing={2}>
                    ...
                    {detailsDialog.booking.consultationDetails && (
                      <Grid item xs={12}>
                        <Typography variant="subtitle1" fontWeight="bold">Consultation Details</Typography>
                        <Typography variant="body1">
                          {detailsDialog.booking.consultationDetails || 'N/A'}
                        </Typography>
                      </Grid>
                    )}
                  </Grid>
