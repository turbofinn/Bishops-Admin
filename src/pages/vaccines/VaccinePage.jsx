    ...
    <Grid container rowSpacing={4.5} columnSpacing={2.75}>
      <Grid size={{ xs: 12, md: 12, lg: 12 }}>
        <Grid container alignItems="center" justifyContent="space-between">
          ...
          <Grid>
            <Button variant="contained" color="primary" startIcon={<AddIcon />} onClick={handleAddVaccine} disabled={saving}>
              Add Vaccine
            </Button>
          </Grid>
        </Grid>
        <MainCard sx={{ mt: 2 }} content={false}>
          {loading ? (
            ...
            <VaccinesTable vaccines={vaccines} onEdit={handleEditVaccine} onStatusChange={handleStatusChange} />
          )}
        </MainCard>
      </Grid>

      <VaccineFormDialog open={openDialog} onClose={handleCloseDialog} onSave={handleSaveVaccine} vaccine={currentVaccine} />
